...
namespace DbFirstApproach.Controllers
{
    ...
    {
        private EFCRUDSEntities db = new EFCRUDSEntities();
        ...
        public ActionResult Create([Bind(Include = "Id,EmpCode,Name,designation,Salary")] EmployeeMaster employeeMaster)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,EmpCode,Name,designation,Salary")] EmployeeMaster employeeMaster)
        {
            if (ModelState.IsValid)
            {
